...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        // Institutional depth — pure black with minimal opacity to prevent dark-mode glowing
        floating: "0 2px 4px rgba(0,0,0,0.02), 0 12px 32px rgba(0,0,0,0.06), 0 24px 64px rgba(0,0,0,0.04)",
