  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-8">
      ...
      <div className="text-center max-w-2xl mx-auto mt-4 mb-10">
        <h1 className="text-display font-bold text-on_surface font-display text-4xl mb-3">Mint Asset</h1>
      ...
      {/* Main Form Card */}
      <div className="bg-surface_container_lowest rounded-2xl p-8 xl:p-10 shadow-[0_8px_24px_rgba(0,0,0,0.02)] border border-outline_variant/10">
        ...
        <form className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs font-bold text-on_surface mb-2">Total Area (sq. ft.)</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-xs font-bold text-on_surface mb-2">Property Type</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                  <span className="text-on_surface_variant/50 font-medium">🏢</span>
                </div>
          ...
          {/* Row 3 Address */}
          <div>
            <label className="block text-xs font-bold text-on_surface mb-2">Site Address</label>
          ...
          <div className="w-full h-48 sm:h-64 rounded-xl border border-outline_variant/20 overflow-hidden relative group">
             ...
             {/* Map Status Bar */}
             <div className="absolute bottom-4 inset-x-4 bg-surface_container_lowest/90 backdrop-blur-md rounded-lg p-3 flex justify-between items-center shadow-sm border border-outline_variant/10">
               <div className="flex items-center gap-2">
                 <Target size={14} className="text-[#835500]" />
                 <span className="text-[10px] font-bold text-on_surface uppercase tracking-widest">Geofence Coordinates Sync Enabled</span>
               </div>
          ...
          <div className="pt-8 border-t border-outline_variant/10 flex justify-between items-center">
            <button type="button" className="text-xs font-bold text-on_surface_variant uppercase tracking-widest hover:text-on_surface transition-colors leading-[48px]">
              Save As Draft
            </button>
            <Button 
              type="button" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        <div className="bg-primary/5 border border-primary/10 rounded-2xl p-6">
          ...
          <h4 className="font-bold text-on_surface mb-3 text-sm">Regulatory Compliance</h4>
        ...
        <div className="bg-[#835500]/5 border border-[#835500]/10 rounded-2xl p-6">
          ...
          <h4 className="font-bold text-on_surface mb-3 text-sm">Immutable Records</h4>
          <p className="text-xs text-on_surface_variant leading-relaxed">
            Data submitted here is hashed and prepared for the Ethereum Mainnet ledger.
          </p>
        </div>

        <div className="bg-surface_container_low border border-outline_variant/10 rounded-2xl p-6">
          <div className="w-6 h-6 rounded-full bg-on_surface_variant flex items-center justify-center text-white mb-4">
            <Clock size={12} />
          </div>
          <h4 className="font-bold text-on_surface mb-3 text-sm">Need Help?</h4>
          <p className="text-xs text-on_surface_variant leading-relaxed">
