  ...
  return (
    <div className="min-h-screen bg-surface_bright flex flex-col font-body">
          ...
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2">
              <span className="text-xl font-bold text-primary font-display tracking-tight">
                Prop<span className="text-on_surface">Chain</span>
              </span>
            </Link>
            <nav className="hidden md:flex gap-6">
              <Link href="#" className="text-sm font-medium text-on_surface_variant hover:text-primary transition-colors">
                Network
              </Link>
              <Link href="#" className="text-sm font-medium text-on_surface_variant hover:text-primary transition-colors">
                Docs
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-surface_container_lowest to-surface_container_low/30 pt-16 pb-24 lg:pt-24 lg:pb-32">
          <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-xl mx-auto lg:mx-0 z-10 w-full">
              ...
              <h1 className="text-display font-display text-on_surface mb-6 leading-[1.05]">
                Tokenize Real-World <span className="text-primary">Real Estate</span> with AI & Blockchain
              </h1>
              
              <p className="text-body-md text-on_surface_variant mb-8 xl:mb-10 max-w-lg leading-relaxed text-lg">
              ...
              <div className="flex items-center gap-6 opacity-60 grayscale">
                <p className="text-xs font-semibold tracking-wider text-on_surface_variant uppercase">Trusted By</p>
                <Building2 size={24} />
                <Shield size={24} />
                <Asterisk size={24} />
              </div>
            ...
            <div className="relative mx-auto lg:mx-0 w-full max-w-lg lg:max-w-none flex justify-center lg:justify-end perspective-1000">
              {/* Main Card */}
              <div className="relative w-full max-w-md bg-surface_container_lowest rounded-2xl p-4 shadow-floating border border-outline_variant/20 -rotate-1 hover:rotate-0 transition-transform duration-500 ease-out z-10">
                ...
                <div className="px-2 pb-2">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-xl font-bold font-display text-on_surface">The Azure Heights</h3>
                      <p className="text-xs font-mono text-on_surface_variant mt-1">ID: PC-8829 NYC</p>
                    </div>
                  ...
                  <div className="flex gap-8 border-t border-outline_variant/20 pt-4 mt-2">
                    <div>
                      <p className="text-[10px] uppercase font-semibold text-on_surface_variant mb-1">TVL</p>
                      <p className="font-semibold text-on_surface">$4.2M</p>
                    </div>
                    <div>
                      <p className="text-[10px] uppercase font-semibold text-on_surface_variant mb-1">Fractions</p>
                      <p className="font-semibold text-on_surface">1.2k</p>
                    </div>
                  </div>
                </div>

                {/* Floating status badge */}
                <div className="absolute -bottom-6 -left-6 sm:-left-10 bg-surface_container_lowest rounded-xl p-3 sm:p-4 shadow-card border border-outline_variant/10 flex items-center gap-3 animate-in fade-in slide-in-from-bottom flex-shrink-0 z-20">
                  <div className="w-8 h-8 rounded-full bg-secondary/10 flex items-center justify-center flex-shrink-0">
                    <CheckCircle2 size={16} className="text-secondary" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-on_surface leading-tight">AI Document Audit Complete</p>
                  </div>
                </div>
              </div>
        ...
        {/* Features Section */}
        <section className="py-20 lg:py-32 bg-surface_container_lowest border-t border-outline_variant/10">
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mb-16">
              <h2 className="text-3xl sm:text-4xl font-display font-bold text-on_surface mb-6 leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Card 1 */}
              <div className="lg:col-span-1 bg-surface_container_lowest border border-outline_variant/20 shadow-[0_8px_24px_rgba(0,0,0,0.04)] rounded-2xl p-8 flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300">
                <div>
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6">
                    <Sparkles size={18} />
                  </div>
                  <h3 className="text-xl font-bold font-display text-on_surface mb-3">AI Document Verification</h3>
                  <p className="text-on_surface_variant text-sm leading-relaxed mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="bg-surface_container text-xs font-medium text-on_surface_variant rounded-md shadow-none hover:bg-surface_container">
                    Neural Audit V4
                  </Badge>
                  <Badge variant="outline" className="bg-surface_container text-xs font-medium text-on_surface_variant rounded-md shadow-none hover:bg-surface_container">
                    NLP Deed Scanning
              ...
              {/* Card 3 */}
              <div className="lg:col-span-1 bg-surface_container_low border border-outline_variant/20 rounded-2xl p-8 flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300">
                <div>
                  <div className="w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary mb-6">
                    <Building size={18} />
                  </div>
                  <h3 className="text-xl font-bold font-display text-on_surface mb-3">Institutional Trust</h3>
              ...
              {/* Card 4 - Wide */}
              <div className="md:col-span-2 lg:col-span-3 bg-surface_container_lowest border border-outline_variant/20 shadow-[0_8px_24px_rgba(0,0,0,0.04)] rounded-2xl p-8 lg:p-12 overflow-hidden flex flex-col md:flex-row items-center gap-8 md:gap-16 hover:-translate-y-1 transition-transform duration-300">
                <div className="flex-1">
                  <h3 className="text-2xl font-bold font-display text-on_surface mb-4">24/7 Global Liquidity</h3>
                  <p className="text-on_surface_variant text-base leading-relaxed max-w-xl">
        ...
        {/* Stats Section */}
        <section className="py-20 bg-surface_container_low border-y border-outline_variant/10">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 divide-x-0 md:divide-x divide-outline_variant/20 text-center md:text-left">
              <div className="pl-0">
                <p className="text-[10px] sm:text-xs font-bold tracking-wider text-on_surface_variant uppercase mb-2">Total Value Locked</p>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-on_surface tracking-tight">$2.4B+</p>
              </div>
              <div className="md:pl-12">
                <p className="text-[10px] sm:text-xs font-bold tracking-wider text-on_surface_variant uppercase mb-2">Properties Minted</p>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-on_surface tracking-tight">14.2k</p>
              </div>
              <div className="md:pl-12">
                <p className="text-[10px] sm:text-xs font-bold tracking-wider text-on_surface_variant uppercase mb-2">Verification Time</p>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-on_surface tracking-tight">1.4s</p>
              </div>
              <div className="md:pl-12">
                <p className="text-[10px] sm:text-xs font-bold tracking-wider text-on_surface_variant uppercase mb-2">Global Jurisdictions</p>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-on_surface tracking-tight">32+</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="py-24 lg:py-32 bg-surface_container_lowest">
          <div className="container mx-auto px-6">
      ...
      {/* Footer */}
      <footer className="bg-surface_container_low pt-16 pb-8 border-t border-outline_variant/20">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              <h4 className="font-semibold text-on_surface mb-4">Product</h4>
              <ul className="space-y-3 text-sm text-on_surface_variant">
            ...
            <div>
              <h4 className="font-semibold text-on_surface mb-4">Company</h4>
              <ul className="space-y-3 text-sm text-on_surface_variant">
            ...
            <div>
              <h4 className="font-semibold text-on_surface mb-4">Resources</h4>
              <ul className="space-y-3 text-sm text-on_surface_variant">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-outline_variant/20 text-xs text-on_surface_variant">
            <p>© 2024 PropChain AI. All rights reserved.</p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <Link href="#" className="hover:text-on_surface">Privacy Policy</Link>
              <Link href="#" className="hover:text-on_surface">Terms of Service</Link>
              <Link href="#" className="hover:text-on_surface">Cookie Settings</Link>
            </div>
          </div>
        </div>
      </footer>
