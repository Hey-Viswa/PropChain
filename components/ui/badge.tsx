  ...
  "inline-flex items-center rounded-full px-3 py-1 text-xs font-medium transition-colors",
  {
    variants: {
      variant: {
        ...
        ai_parsing: "bg-surface_container_high text-on_surface_variant dark:text-[#9ba3b8]",
        rejected: "bg-error_container text-on_error_container",
        transferred: "bg-surface_container dark:bg-[#1c2333] text-on_surface_variant dark:text-[#9ba3b8]",
